...
class English extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "en": {
          ...
          "password_not_match": "Password doesn't match Confirm Password !",

          // ---------- Home ---------- //
          "search": "Search the entire shop",
          ...
          "ok": "OK",
          "check_intenet": "Check your Intenet Connection And Try Again !",
          "no_internet": "No Internet !",
          "no_data": "No data found !",
          "warning": "Warning",
          "wrong_code": "Wrong verify Code !!",
          "email_exists":
